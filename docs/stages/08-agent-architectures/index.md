...
**Phase 2 - Agent Core**  
Stage 8 of 14. Previous: [Stage 7 - RAG and Memory](../07-rag-and-memory/index.md). Next: [Stage 9 - Building Agents](../09-building-agents/index.md).
...
=======
- [ReAct agents](react-agents/index.md)
- RAG agents
...
Use the [Stage 8 checkpoint](checkpoint.md) before moving on.
