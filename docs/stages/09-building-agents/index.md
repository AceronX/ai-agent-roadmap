...
**Phase 2 - Agent Core**  
Stage 9 of 14. Previous: [Stage 8 - Agent Architectures](../08-agent-architectures/index.md). Next: [Stage 10 - Multi-Agent Systems](../10-multi-agent-systems/index.md).
...
- [Building an agent loop from scratch](agent-loop-from-scratch/index.md)
...
Use the [Stage 9 checkpoint](checkpoint.md) before moving on.
